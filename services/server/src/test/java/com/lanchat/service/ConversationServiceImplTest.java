...
class ConversationServiceImplTest {
    ...
    void groupSendPathDoesNotResynchronizeEveryMember() {
        ...
        var guard = mock(com.lanchat.recovery.ConversationWriteGuard.class);
        when(guard.permission("group:3", 7L)).thenReturn(new com.lanchat.recovery.ConversationWriteGuard.Permission(true, true));
        org.springframework.test.util.ReflectionTestUtils.setField(service, "writeGuard", guard);
