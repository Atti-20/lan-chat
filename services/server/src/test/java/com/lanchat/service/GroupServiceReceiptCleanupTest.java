...
class GroupServiceReceiptCleanupTest {
    ...
    void setUp() {
        ...
        ReflectionTestUtils.setField(service, "accessMutationRecorder", mock(com.lanchat.recovery.AccessMutationRecorder.class));
        ReflectionTestUtils.setField(service, "messageMutationRecorder", mock(com.lanchat.recovery.MessageMutationRecorder.class));
        ReflectionTestUtils.setField(service, "attachmentCleanup", mock(com.lanchat.service.MessageAttachmentCleanup.class));
    }
