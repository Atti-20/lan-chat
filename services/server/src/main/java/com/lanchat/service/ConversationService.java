...
public interface ConversationService {
    ...
    void lockConversationForWrite(String conversationId);

    void lockPrivateConversationForWrite(Long firstUserId, Long secondUserId);

    boolean canAccessForWrite(String conversationId, Long userId);

    List<Long> getReadableRecipientsForWrite(String conversationId);
