...
.status-badge { padding: 5px 9px; border-radius: 999px; color: var(--green); font-size: var(--font-caption); font-weight: 700; background: color-mix(in srgb, var(--green) 10%, transparent); }
...
.cancel-button { display: inline-flex; min-height: 34px; padding: 0 12px; align-items: center; justify-content: center; border: 0; border-radius: 10px; color: var(--coral); font-size: var(--font-caption); font-weight: 680; line-height: 1; white-space: nowrap; background: color-mix(in srgb, var(--coral) 9%, var(--fill)); cursor: pointer; }
...
.delete-button { display: inline-flex; min-height: 34px; padding: 0 12px; align-items: center; justify-content: center; border: 0; border-radius: 10px; color: var(--coral); font-size: var(--font-caption); font-weight: 680; line-height: 1; white-space: nowrap; background: color-mix(in srgb, var(--coral) 16%, var(--fill)); cursor: pointer; }
...
.refresh-button--icon,
.toolbar-button { min-height: 36px; border: 1px solid var(--separator); border-radius: 10px; color: var(--ink-soft); font-size: var(--font-caption); font-weight: 650; line-height: 1; white-space: nowrap; background: var(--surface); cursor: pointer; }
...
.user-id { padding: 4px 7px; border-radius: 8px; color: var(--ink-soft); font-family: ui-monospace, SFMono-Regular, Menlo, monospace; font-size: var(--font-caption); background: var(--fill); }
...
.empty-kicker { margin: 0 0 5px; color: var(--coral); font-size: var(--font-caption); font-weight: 700; }
